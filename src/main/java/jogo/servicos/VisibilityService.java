...
/**
 * Calcula a parte visível do tabuleiro a partir da posição do jogador.
 * A visão segue as quatro direções e termina depois do primeiro obstáculo.
 */
public class VisibilityService {
    public static final String HIDDEN_POSITION_SYMBOL = "?";
    private static final String PLAYER_SYMBOL = "P";

    // Calcula as posições visíveis nas quatro direções a partir do jogador.
    ...
    // Cria uma representação que esconde todas as posições fora da visão.
    ...
    // Avança em uma direção até sair do mapa ou encontrar um obstáculo.
